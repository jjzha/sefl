#!/bin/bash -l
#SBATCH --job-name=cohere_judge
#SBATCH --output=/scratch/project_xxxxxxxxxx/synthetic-edu-cache/cohere_judge_%j.out
#SBATCH --error=/scratch/project_xxxxxxxxxx/synthetic-edu-cache/cohere_judge_%j.err
...
OUTPUT_CSV="/scratch/project_xxxxxxxxxx/synthetic-edu-cache/tmp_2/results_cohere.csv"

# ------------------------------
# Run command inside container
# ------------------------------
echo "Starting Command-R judge script..."
...
srun singularity exec -B /scratch/project_xxxxxxxxxx/ \
     ...
     bash -c "\
        ...
        python src/analysis/command-r_as_a_judge.py \
            --input_csv $INPUT_CSV \
            --output_csv $OUTPUT_CSV \
            --gpt_model command-r-plus-08-2024 \
     "
